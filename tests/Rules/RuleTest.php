...
final class RuleTest extends TestCase {
  public function testPercentageReduction() {
    ...
    $price = 100;
    $reduction = 50;
    $rule = new Rule(Rule::TYPE_PERCENT, $reduction);
  ...
  public function testPercentageAdd() {
    ...
    $price = 100;
    $increase = 50;
    $rule = new Rule(Rule::TYPE_PERCENT_ADD, $increase);
  ...
  public function testFixed() {
    ...
    $price = 100;
    $decrease = 99;
    $rule = new Rule(Rule::TYPE_FIXED, $decrease);
  ...
  public function testFixedAdd() {
    ...
    $price = 100;
    $increase = 99;
    $rule = new Rule(Rule::TYPE_FIXED_ADD, $increase);
  ...
  public function testFixedSet() {
    ...
    $price = 100;
    $fixed = 9;
    $rule = new Rule(Rule::TYPE_FIXED_SET, $fixed);
